...
<div class="container-fluid py-5 mb-5">
    <div class="container h-100">
        <div class="row g-5 h-100 justify-content-center align-items-center">
            <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.1s">
                <div class="bg-light rounded h-100 p-5 d-flex flex-column justify-content-between mb-5">
            ...
            <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.6s">
